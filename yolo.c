...
char *voc_names[] = {"sh", "su", "se"};
image voc_labels[CLASSNUM];

void train_yolo(char *cfgfile, char *weightfile)
{
    /* Change training folders here */
    char *train_images = "/home/xhuv/darknet_faceID/darknet/data/train_all.txt";

    /* Change output weight folders here */
    char *backup_directory = "/home/xhuv/darknet_faceID/darknet/scripts/backup/";
